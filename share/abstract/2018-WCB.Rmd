...
# Introduction
The occurrence of work-related upper limb injuries has been associated with sex [@treaster_gender_2004].
While sex differences in motor behavior have been identified [@cote_critical_2012], knowledge is limited for dynamic shoulder movements.
...
Kinematics of the upper arm were recorded and the SHR was computed dynamically using a 3D approach [@robert-lachaine_elucidating_2015], which includes all rotations of each shoulder joints.
Men's and women's SHR were compared using statistical non-parametric mapping (non-parametric 2-way ANOVA: sex × height [repeated measures]).
...
A significant main effect of mass (between 41 and 55% of the trial, p=0.025 and p=0.004, respectively) on the SHR (Fig. 1) shows a higher SHR in both men and women at 6 kg compared to 12 kg during the box elevation.
...
This result means that men are more likely to use the glenohumeral joint and/or less the scapulo-thoracic joints to lift a box at eye level at either 6 or 12 kg.
...
Thus, when efforts are closer to the maximal capacity, the glenohumeral joint cannot contribute as much and the arm elevation relies on the scapulo-thoracic joints.
